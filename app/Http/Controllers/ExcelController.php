        ...
        Excel::create('Lista_Todos_Registrados',function($excel)
        {
            $excel->sheet('Registrados',function($sheet)
            {
                    $users = DB::table('usuario')
                        ...
                        ->select('usuario.apellidoPaterno as A.Paterno','usuario.apellidoMaterno as A.Materno','usuario.nombre as Nombre','usuario.boleta as Boleta','carrera.nombre as Carrera','antecedentes.promActual as Promedio','usuario.edad as Edad','usuario.semestre as Semestre','usuario.grupo as Grupo','personales.nomTutor as NombreTutor','personales.telTutor as TelefonoTutor','personales.telCasa as TelefonoCasa','personales.telCelular as TelefonoCelular','beca.nombre as BecaASolicitar','antecedentes.licenciatura as LicenciaturaTerminada','antecedentes.historiaAC as Status','municipio.nombre as Municipio','estado.nombre as Estado','vivienda.habitantes as PersonasQueVivenEnCasa','vivienda.habitaciones as HabitacionesEnCasa','tcasa.nombre as TipoCasa','vivienda.residencia as ResidenciaMientrasEstudia','vivienda.calle as Calle','vivienda.numExterior as NumeroExterior','vivienda.numInterior as NumeroInterior','vivienda.colonia as Colonia','vivienda.codigoPostal as CodigoPostal','vivienda.tiempo as TiempoEnLlegarEcuela','transporte.nombre as MedioTransporte','vivienda.viajeMensual as ViajeMensualForaneo','vivienda.transporte as TransporteForaneo','vivienda.gastoMensual as GastoMensualForaneo','gasto.ingresoMensual as IngresoMensualFamilia','gasto.gastoMensual as GastoMensual','gasto.noIntegrantes as numIntegrantesEnFamilia','gasto.apoyo as ApoyanEnFamilia','gasto.trabajo as Trabajas','gasto.dependencia as Dependencia','personales.enfermedades as Enfermedades')
